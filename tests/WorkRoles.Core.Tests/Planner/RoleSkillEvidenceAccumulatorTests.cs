...
public class RoleSkillEvidenceAccumulatorTests
{
    ...
    public async Task ScratchDeduplicatesSourcesAndPerSourceFactsThenResetsForNextRole()
    {
        ...
        await Assert.That(string.Join(",", first.Select(e => e.SkillDefName))).IsEqualTo("Crafting,Intellectual");
    ...
    public async Task StampRolloverResetsBeforeIncrementWithoutLosingCurrentRoleEvidence()
    {
        ...
        var sourceStamp = typeof(RoleSkillEvidenceAccumulator).GetField("sourceStamp", System.Reflection.BindingFlags.Instance | System.Reflection.BindingFlags.NonPublic)!;
        ...
        await Assert.That(evidence.Single(e => e.SkillDefName == "Crafting").UsedJobs).IsEqualTo(1);
        await Assert.That(evidence.Single(e => e.SkillDefName == "Intellectual").TrainedJobs).IsEqualTo(1);

        var roleStamp = typeof(RoleSkillEvidenceAccumulator).GetField("roleStamp", System.Reflection.BindingFlags.Instance | System.Reflection.BindingFlags.NonPublic)!;
