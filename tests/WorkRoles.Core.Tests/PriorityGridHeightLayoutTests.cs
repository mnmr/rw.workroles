...
public class PriorityGridHeightLayoutTests
{
    ...
    {
        var layout = PriorityGridHeightLayout.Calculate(
            rowCount: 3,
            rowHeight: 27f,
            fixedContentHeight: 108f,
            windowMarginsHeight: 36f,
            scrollChromeHeight: 24f,
            maxWindowHeight: 900f);
    ...
    [Test]
    public async Task ImpossibleOrInvalidHeightBudgetsAreRejected()
    {
        await Assert.That(() => PriorityGridHeightLayout.Calculate(
                rowCount: -1,
                rowHeight: 27f,
                fixedContentHeight: 108f,
                windowMarginsHeight: 36f,
