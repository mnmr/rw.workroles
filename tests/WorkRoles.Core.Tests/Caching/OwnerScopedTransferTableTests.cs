...
public class OwnerScopedTransferTableTests
{
    ...
    public async Task PropagationUsesKeyIdentityAndConsumptionIsOneShot()
    {
        ...
        await Assert.That(transfers.TryGet(equalButDifferentSource, owner, out _)).IsFalse();
    ...
    private sealed class ValueEqualKey
    {
        ...
        public override bool Equals(object obj) => obj is ValueEqualKey other && other.value == value;
